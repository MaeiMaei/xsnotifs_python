...
content = xsoverlay_content(title="Hello world", 
                            content="This is an app sent by my script, if you can read this, I have launched the nukes", 
                            sourceApp="My app",
                            icon = "default")

send_to_socket(content=content)
